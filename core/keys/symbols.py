...
symbols = [
    ...
    Symbol("+", None, ["plus"]),
    Symbol("~", ["tilde", "wave"]),
    Symbol("_", None, ["down score", "underscore", "under"]),
    Symbol("(", ["paren", "L paren", "left paren"], ["open paren", "paren"]),
    Symbol(")", ["R paren", "right paren"], ["close paren"]),
    Symbol("[", None,["brack", "L brack", "bracket", "L bracket", "left bracket", "square", "L square", "left square", "open square"],),
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "close square"]),
    Symbol("/", ["forward slash"], ["slash", "stroke"]),
    Symbol("\\", None, ["backslash", "whack"]),
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "open curly"],),
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket", "close curly", "right curly"]),
